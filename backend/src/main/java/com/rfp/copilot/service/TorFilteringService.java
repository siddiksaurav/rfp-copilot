...
public class TorFilteringService {
    ...
    public TorFilteringService(DocumentProcessingService documentService, LlmService llmService, CompanyProfileService companyProfileService) {
        this.documentService = documentService;
        this.llmService = llmService;
        this.companyProfileService = companyProfileService;
    }

    public BidDecision analyzeTorSuitability(String torDocumentId, String companyProfileId) {

        List<String> technicalRequirements = documentService.extractTechnicalRequirements(torDocumentId);

        Map<String, Object> timelineInfo = documentService.extractTimelineInformation(torDocumentId);

        Map<String, Object> companyCapabilities = companyProfileService.getCompanyCapabilities(companyProfileId);
